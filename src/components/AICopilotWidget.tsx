...
export function AICopilotWidget({
  ...
  return (
    ...
    >
      <div className="p-4 rounded-3xl bg-[#111111]/95 border border-[#DEDBC8]/30 backdrop-blur-2xl shadow-2xl space-y-3 relative overflow-hidden" data-tour="copilot-widget">
        {/* Ambient Top Glow */}
        <div className="absolute -top-10 -right-10 w-32 h-32 bg-[#DEDBC8]/10 rounded-full blur-2xl pointer-events-none" />

        {/* Header */}
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className="w-7 h-7 rounded-xl bg-[#DEDBC8]/15 p-0.5 border border-[#DEDBC8]/30 overflow-hidden flex items-center justify-center">
              <img src="/logo.png" alt="Copilot Logo" className="w-full h-full object-contain" />
            </div>
            <div>
              <span className="text-xs font-bold text-[#F7F6F1] block leading-none">
          ...
          <div className="space-y-3 pt-1">
            ...
            {!appliedFixes ? (
              <button
                ...
                className="w-full py-2 rounded-xl bg-[#DEDBC8] hover:bg-[#ECE8D9] text-black font-extrabold text-xs transition-all shadow-[0_0_15px_rgba(222,219,200,0.22)] flex items-center justify-center space-x-1.5 cursor-pointer active:scale-95 border border-white/20"
              >

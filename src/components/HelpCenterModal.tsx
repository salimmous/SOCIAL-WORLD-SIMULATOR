    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-xl font-sans">
        <motion.div
          ...
          className="w-full max-w-4xl h-[85vh] bg-zinc-950 border border-white/10 rounded-3xl overflow-hidden shadow-2xl flex flex-col"
        >
          {/* Header */}
          <div className="px-6 py-4 bg-zinc-900/80 border-b border-white/10 flex items-center justify-between shrink-0">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-base font-extrabold text-white">Help Center & Documentation</h2>
          ...
          {/* Navigation Tabs Bar */}
          <div className="px-6 py-3 bg-zinc-900/40 border-b border-white/10 flex space-x-2 shrink-0 font-mono text-xs overflow-x-auto">
            {[
          ...
          <div className="p-6 overflow-y-auto flex-1 space-y-6">
            {tab === 'docs' && (
              <div className="space-y-4">
                <div className="p-5 rounded-2xl bg-purple-600/10 border border-purple-500/30 flex items-center justify-between">
                  <div>
                    <h3 className="text-sm font-bold text-white">Interactive Guided Product Tour</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 rounded-2xl bg-zinc-900/60 border border-white/10 space-y-2">
                    <h4 className="text-xs font-bold text-purple-300 font-mono">1. Content Intelligence</h4>
                  ...
                  <div className="p-4 rounded-2xl bg-zinc-900/60 border border-white/10 space-y-2">
                    <h4 className="text-xs font-bold text-purple-300 font-mono">2. Social World Physics</h4>
                    <p className="text-xs text-zinc-400 leading-relaxed">
                  ...
                  <div className="p-4 rounded-2xl bg-zinc-900/60 border border-white/10 space-y-2">
                    <h4 className="text-xs font-bold text-purple-300 font-mono">3. Optimization Lab</h4>
                    <p className="text-xs text-zinc-400 leading-relaxed">
                  ...
                  <div className="p-4 rounded-2xl bg-zinc-900/60 border border-white/10 space-y-2">
                    <h4 className="text-xs font-bold text-purple-300 font-mono">4. Executive Exporter</h4>
                    <p className="text-xs text-zinc-400 leading-relaxed">
              ...
              <div className="space-y-3 font-mono text-xs">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={k.key} className="p-3 rounded-2xl bg-zinc-900/60 border border-white/10 flex items-center justify-between">
                      <span className="px-2 py-1 rounded-lg bg-black border border-white/10 text-purple-300 font-bold">
                        {k.key}
                      </span>
              ...
              <div className="space-y-4 font-mono text-xs">
                ...
                <div className="p-4 rounded-2xl bg-zinc-900/60 border border-white/10 space-y-2">
                  ...
                  <div className="flex justify-between border-b border-white/5 py-1.5">
                    ...
                    <span className="text-purple-300">ElevenLabs AI Speech Synthesis</span>
                  </div>
                  <div className="flex justify-between border-b border-white/5 py-1.5">
            ...
            {tab === 'changelog' && (
              <div className="space-y-3 font-mono text-xs">
                ...
                <div className="p-4 rounded-2xl bg-zinc-900/60 border border-white/10 space-y-2 text-zinc-300">
          ...
          <div className="px-6 py-4 bg-zinc-900/80 border-t border-white/10 flex items-center justify-between shrink-0 font-mono text-xs">
            ...
            <button
              onClick={onClose}
              className="px-5 py-2 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-bold transition-all cursor-pointer font-sans"
            >
              Close Help Center
            </button>
          </div>

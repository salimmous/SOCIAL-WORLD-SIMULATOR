        ...
        >
          ...
          <div className="px-6 py-4 border-b border-white/10 bg-zinc-900/80 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-base font-bold text-white flex items-center space-x-2">
                  ...
                  <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono bg-purple-500/20 text-purple-300 font-bold border border-purple-500/30">
            ...
            <div className="flex items-center space-x-2">
              <button
                onClick={handlePrint}
                className="px-3.5 py-1.5 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-white text-xs font-bold transition-all cursor-pointer flex items-center space-x-1.5 border border-white/10"
              >
          ...
          <div className="flex-1 overflow-y-auto p-8 space-y-6 bg-zinc-950 text-zinc-100 font-sans print:p-0 print:bg-white print:text-black">
            {/* Report Header Info */}
            <div className="border-b border-white/10 pb-6 flex items-start justify-between">
              <div>
                ...
                <p className="text-xs text-zinc-400 mt-1 font-mono">
                  Target Platform: <strong className="text-purple-300 uppercase">{content.platform}</strong> • Target Audience: <strong className="text-purple-300">{content.targetAudience}</strong>
                </p>
              </div>
            ...
            <div className="grid grid-cols-4 gap-3">
              <div className="p-3.5 rounded-xl bg-zinc-900/60 border border-white/10 space-y-1">
                <span className="text-[9px] font-mono text-zinc-400 uppercase block">Virality Index</span>
                <span className="text-base font-extrabold text-purple-300 font-mono">{metrics.viralityScore}</span>
              </div>
              <div className="p-3.5 rounded-xl bg-zinc-900/60 border border-white/10 space-y-1">
              ...
              <div className="p-3.5 rounded-xl bg-zinc-900/60 border border-white/10 space-y-1">
                ...
                <span className="text-xs font-bold text-amber-300 font-mono line-clamp-1">{metrics.estimatedReach}</span>
              </div>
            </div>
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="space-y-2">
                <div className="p-3 rounded-xl bg-zinc-900/40 border border-white/5 flex items-start space-x-3 text-xs">
          ...
          {/* Footer */}
          <div className="px-6 py-3 border-t border-white/10 bg-black/60 flex items-center justify-between text-xs text-zinc-400">
